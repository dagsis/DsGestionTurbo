...
Begin VB.Form VentaNotaCredito 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Notas de Creditos/Debitos"
   ClientHeight    =   6210
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9420
   ...
   End
End
Attribute VB_Name = "VentaNotaCredito"
...
Private Sub CmbComprobante_Click()
  Dim cNum As ClsComprobantesL, nNum As String * 6, nSuc As String * 6
  On Error GoTo errHandler

  If sw = False Then
     Set cNum = New ClsComprobantesL
     nNum = Format(cNum.TraerUltimoNumeroVenta(CmbComprobante.ItemData(CmbComprobante.ListIndex)), "000000")
     nSuc = Format(cNum.TraerSucursalNumero(CmbComprobante.ItemData(CmbComprobante.ListIndex)), "000000")
...
Private Sub CmdClientes_Click()
  ...
  If nDat <> 0 Then
     ...
     LbLIva.Caption = cRiL.BuscarTipoIva(RsC!Cliente)
     CmBVendedor.text = cRsl.DatoCombo("Vendedores", "Vendedor", "Descripcion", cRcL.BuscarVendedor(RsC!Cliente))
...
Private Sub Limpiar()
  ...
  LblNumero.Caption = "000000-000000"
  LbLIva.Caption = ""
...
Private Sub LinkearTexto()
  ...
  nNum = Format(Rs!Numero, "000000")
  nSuc = Format(Rs!Sucursal, "000000")
  LblNumero.ForeColor = &H80000012
...
Private Sub TxtCliente_LostFocus()
  ...
  If TxtCliente.text <> "" Then
     If cRcL.BuscarNombreCliente(TxtCliente.text) <> "" Then
        ...
        LbLIva.Caption = cRiL.BuscarTipoIva(TxtCliente.text)
...
'  RsCv!Id = 0
  ...
  RsCv!Numero = Right(LblNumero.Caption, 6)
  RsCv!Sucursal = Left(LblNumero.Caption, 6)
