VERSION 5.00
Begin VB.Form TblCajas 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Abm de Cajas"
   ClientHeight    =   3525
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6510
...
Private Sub Borrar()
  ...
  nList = List1.ListIndex
    If cRx.TraerCantidad("CabComprobantes", "Caja", "Caja=" & Val(Label3.Caption)) = 0 And _
     cRx.TraerCantidad("Registros", "Caja", "Caja=" & Val(Label3.Caption)) = 0 Then

        If MsgBox("Borra La Caja Seleccionada ?", 20, "Atención") = 6 Then
           sCod = Label3.Caption
           cRse.Actualizar "CajaBorrar", , Val(Label3.Caption), "Caja"
           CargarLista
           Limpiar
           Botones True, False, False, False, True
            If Rs.EOF = False Or Rs.BOF = False Then
        ...
        End If
    Else
       MsgBox "Caja Asignada a un Movimiento o Registro por Defecto", vbCritical, "Atención"
    End If
  Exit Sub
errHandler:
  ManejaErrores
...
Private Sub CargarLista()
  ...
  List1.Clear
  Set Rs = cRsl.TraerRS("CajaTraerTodos", , True)
