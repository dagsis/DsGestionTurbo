...
Begin VB.Form CompraVerPagos 
   ...
   End
End
Attribute VB_Name = "CompraVerPagos"
...
Private Sub CmdImprimir_Click()
  ...
  Printer.CurrentX = 1
  Printer.Print "Proveedor :" & LblCliente.Caption
  Printer.CurrentY = 5
  Printer.CurrentX = 1
  Printer.Print "Domicilio :" & cRsl.TraerValorDeUnCampo("Clientes", "Domicilio", "Cliente='" & ComprasAnularPagos.TxtCliente.text & "'")
  Printer.CurrentY = 5.5
  Printer.CurrentX = 1
  Printer.Print "Localidad :"
  Printer.CurrentY = 6
  Printer.CurrentX = 1
  Printer.Print "CUIT :" & cRsl.TraerValorDeUnCampo("Proveedores", "Cuit", "Proveedor='" & ComprasAnularPagos.TxtCliente.text & "'")
...
'     Printer.Print cNum.NumeroAsiento
     ...
     Printer.CurrentX = 18 - Printer.TextWidth(Format(cImpo))
     Printer.Print Format(cImpo)
     cSaldo = cSaldo + cImpo
     Rs1.MoveNext
     pY = pY + 0.5
  Loop
...
Private Sub Form_Load()
  ...
  CrearRsComprobantes
  CrearRsFormaPago
  Set Rs = ComprasAnularPagos.RsAp
  LinkearTexto
End Sub
...
Private Sub LinkearTexto()
  ...
  LblCliente.Caption = ComprasAnularPagos.LblCliente.Caption
  LlenarRs2
  LlenarRs1
...
Private Sub LlenarRs1()
  ...
  Do While Not rAux.EOF
     ...
     Rs1!importe = Format(cRsl.TraerValorDeUnCampo("CabComprobantes", "Haber", "Movimiento=" & rAux!Tasa), "0.00")
...
Private Sub LlenarRs2()
  ...
  Do While Not rAux.EOF
     ...
     If Not IsNull(rAux!Banco) Then
       If rAux!formapago <> "CHEQUES PROPIOS" Then
          Rs2!Banco = cRsl.TraerValorDeUnCampo("Bancos", "Descripcion", "Banco=" & rAux!Banco)
       Else
          Rs2!Banco = cRsl.TraerValorDeUnCampo("CuentasBancarias", "Descripcion", "Id=" & rAux!Banco)
       End If
     End If
