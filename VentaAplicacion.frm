...
Begin VB.Form VentaAplicacion 
   ...
   End
End
Attribute VB_Name = "VentaAplicacion"
...
Private Sub CmdBotones_Click(Index As Integer)
  ...
  Select Case Index
         ...
         Case 1
              ...
              bApli = False
              If cRx.TieneAplicacion(VentaComprobantes.CmbComprobante.ItemData(VentaComprobantes.CmbComprobante.ListIndex), Right(LblNumero.Caption, 8), VentaComprobantes.TxtCliente.text) <> 0 Then
                 bApli = True
...
End Sub
Private Sub Salir()
  If CmdBotones(1).Enabled = True Or Val(lblTotal.Caption) <> 0 Then
...
Private Sub LlenarGrilla()
 ...
 Set rCuen = cCom.DameCuentaCorriente(VentaComprobantes.TxtCliente.text)
 ...
 Do While Not rCuen.EOF
    ...
    RsC!Cancelado = 0
    RsC!Cobrar = Format((rCuen!Debe * nCotizacion), "#0.00") - RsC!Cobrado
...
Private Sub Form_Load()
  ...
  Botones True, False
  bApli = False
  cApli = cRx.TieneAplicacion(VentaComprobantes.CmbComprobante.ItemData(VentaComprobantes.CmbComprobante.ListIndex), Right(LblNumero.Caption, 8), VentaComprobantes.TxtCliente.text)
  If cApli <> 0 Then
     bApli = True
     Me.Caption = "Nota de Credito Aplicada"
  End If
  ...
  lblTotal.Caption = Format(CCur(VentaComprobantes.lblTotal.Caption) * CCur(VentaComprobantes.TxtCotizacion.text) - cApli, "#0.00")
End Sub
...
Private Sub CargarCombos()
  ...
  LblComprobante.Caption = VentaComprobantes.CmbComprobante.text
  LblNumero.Caption = VentaComprobantes.TxtSucursal.text & "-" & VentaComprobantes.TxtNumero.text
Exit Sub
...
Private Sub GrabarTodo()
 ...
 ' Grabar Valores
  ...
  nCotizacion = VentaComprobantes.TxtCotizacion.text
  ...
  Do While Not RsC.EOF
     If RsC!Cancelado > 0 Then
        ...
        rApli!MoviCta = VentaComprobantes.nMovi
        rApli!Comprobante = VentaComprobantes.CmbComprobante.ItemData(VentaComprobantes.CmbComprobante.ListIndex)
        rApli!Numero = Right(LblNumero.Caption, 8)
        rApli!Sucursal = cNum.TraerSucursalNumero(VentaComprobantes.CmbComprobante.ItemData(VentaComprobantes.CmbComprobante.ListIndex))
        rApli!Cuota = RsC!Cuota
        rApli!importe = RsC!Cancelado '* nCotizacion
        rApli!Retencion = 0
        rApli!GAnancia = 0
        rApli!Anulado = 0
        rApli.Update
