...
Begin VB.Form VentaAdeAplica 
   ...
   End
End
Attribute VB_Name = "VentaAdeAplica"
...
Private Sub CmdBotones_Click(Index As Integer)
  ...
  Select Case Index
         ...
         Case 1
              ...
              bApli = False
              cApli = cRx.TieneAplicacion(VentasAdelanto.CmbComprobante.ItemData(VentasAdelanto.CmbComprobante.ListIndex), Right(LblNumero.Caption, 8), VentasAdelanto.TxtCliente.text)
              If cApli <> 0 Then
                 bApli = True
                 Me.Caption = "Recibo de Cobro Aplicado"
...
Private Sub LlenarGrilla()
 ...
 Set rCuen = cCom.DameCuentaCorriente(VentasAdelanto.TxtCliente.text)
...
Private Sub Form_Load()
  ...
  bApli = False
  cApli = cRx.TieneAplicacion(VentasAdelanto.CmbComprobante.ItemData(VentasAdelanto.CmbComprobante.ListIndex), Right(LblNumero.Caption, 8), VentasAdelanto.TxtCliente.text)
  If cRx.TieneAplicacion(VentasAdelanto.CmbComprobante.ItemData(VentasAdelanto.CmbComprobante.ListIndex), Right(LblNumero.Caption, 8), VentasAdelanto.TxtCliente.text) <> 0 Then
     bApli = True
     Me.Caption = "Recibo de Cobro Aplicado"
  End If
  CmdBotones(0).Picture = LoadResPicture("Salir", 0)
  CmdBotones(1).Picture = LoadResPicture("Grabar", 0)
  lblTotal.Caption = Format(VentasAdelanto.lblTotal.Caption - cApli, "#0.00")
...
Private Sub CargarCombos()
  ...
  LblComprobante.Caption = VentasAdelanto.CmbComprobante.text
  LblNumero.Caption = VentasAdelanto.LblNumero.Caption
Exit Sub
 ...
 ' Grabar Valores
  ...
  Do While Not RsC.EOF
     If RsC!Cancelado > 0 Then
        ...
        rApli!Comprobante = VentasAdelanto.CmbComprobante.ItemData(VentasAdelanto.CmbComprobante.ListIndex)
        rApli!Numero = Right(LblNumero.Caption, 8)
        rApli!Sucursal = cNum.TraerSucursalNumero(VentasAdelanto.CmbComprobante.ItemData(VentasAdelanto.CmbComprobante.ListIndex))
...
' Imprimir Recibo de Cobro
  cGrab.AgregarAplicacion rApli, nLllamaApli
