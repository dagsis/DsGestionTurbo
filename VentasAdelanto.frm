...
Begin VB.Form VentasAdelanto 
   ...
   End
End
Attribute VB_Name = "VentasAdelanto"
...
Dim rAde As ADODB.Recordset, nCh As Integer
     ...
     If CmbValor.ListIndex <> -1 Then
        Select Case cTip.TraerTipoCondicion(CmbValor.ItemData(CmbValor.ListIndex))
               ...
               Case 3
                    ...
                    TxtImporte.SetFocus
               Case 4
                    If cTip.TraerTipoMovimiento(CmbComprobante.ItemData(CmbComprobante.ListIndex)) = 10 Then
                       HabilitarValores True, True, True, False
...
Private Sub Anular()
  ...
  If MsgBox("Anula el Comprobante Seleccionado ?", 20, "Atención") = 6 Then
     ...
     cBor.AnularAdeCliente CmbComprobante.ItemData(CmbComprobante.ListIndex), Rs!Sucursal, Rs!Numero, Rs!Movimiento, True
     Rs_Caj.Delete
     Limpiar
...
Private Sub CargarCombos()
  ...
  Set cRsl = New ClsLectura
  cRsl.CargaCombo CmbValor, "CondVenta", "CondVta", "Descripcion", "Tipo < 6 And Tipo <> 3 Or Tipo = 8" '"tipo=4"
  Set cRsl = New ClsLectura
...
Private Sub ArmaRsParaMovimiento()
  ...
  Set Rs_Caj = cComp.TraerTodosCon("CabComprobantes", "Id", "Tipo=4 and Motivo='ADE'")
  Botones True, False, False, False, False, False, False, True, False
...
Private Sub LinkearTexto()
  ...
  LblCliente.Caption = cRcL.BuscarNombreCliente(Rs!Cliente)
  lblTotal.Caption = Format(Rs!Haber, "#0.00")
Exit Sub
...
'    Else
'        Set rAuxD = cRsl.TraerRsCondi("CtaBanco", "Id", "Movimiento=" & rs!Movimiento)
     End If
  End If
...
Private Sub LinkearDetalles()
  ...
  If Not IsNull(Rsd!formapago) Then
     ...
     If Not IsNull(Rsd!Banco) Then
        If Rsd!formapago <> "INTERDEPOSITOS" Then
...
'  rReci!Id = 0
  ...
  Do While Not Rsd.EOF
     ...
     If cRsl.TraerValorDeUnCampo("CondVenta", "Mueve", "Descripcion='" & Rsd!formapago & "'") <> "No" Then
        ...
        rBanco!fecha = DTPfechaValor.Value
        rBanco!Hora = Time
 ...
 Loop
  ...
  cGrab.AgregarAdelantos RsCv, rReci, Rsd, rCaja, rBanco, True
...
'  Rsd!Id = 0
  ...
  Else
     If cXa.TraerTipoCondicion(CmbValor.ItemData(CmbValor.ListIndex)) = 3 Then
        ...
        Rsd!FechaAcreditacion = DTPfechaValor.Value
     Else
       If cXa.TraerTipoCondicion(CmbValor.ItemData(CmbValor.ListIndex)) = 8 Then
          Rsd!NumeroCheque = TxtCheque.text
          Rsd!Banco = CmbBanco.ItemData(CmbBanco.ListIndex)
          Rsd!Nombre = TxtLibrador.text
       Else
...
Private Sub Imprimir()
  ...
  Printer.CurrentX = 1
  Printer.Print "RECIBO DE COBROS"
...
'  Printer.Print Format(Rs!Asiento, "00000000")
  ...
  Printer.CurrentY = pY
  Printer.CurrentX = 1
  Printer.Print "Recibimos de " & LblCliente.Caption & " la cantidad de $ " & Format(lblTotal.Caption, "#0.00")
  pY = pY + 0.5
  Printer.CurrentY = pY
  Printer.CurrentX = 1
