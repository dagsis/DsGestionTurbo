...
Private Sub LinkearTexto()
  Label3.Caption = Format(Rs!Marca, "00")
...
Private Sub List1_Click()
 ...
 Set Rs = cRsl.TraerRS("MarcaTraerUno", sCod, True)
 LinkearTexto
 Set cRsl = Nothing
Exit Sub
errHandler:
...
Private Sub Borrar()
  ...
  If cRsl.TraerCantidad("Productos", "Marca", "Marca=" & Val(Label3.Caption)) = 0 And _
      cRsl.TraerCantidad("Registros", "Marca", "Marca=" & Val(Label3.Caption)) = 0 Then
     If MsgBox("Borra La Marca Seleccionada ?", 20, "Atención") = 6 Then
        sCod = Label3.Caption
        cRse.Actualizar "MarcaBorrar", Nothing, Val(Label3.Caption), "Marca"
        CargarLista
        Limpiar
        Botones True, False, False, False, True
        If Rs.EOF = False Or Rs.BOF = False Then
    ...
    End If
  Else
       MsgBox "Marca Asignada a un Producto Especifico", vbCritical, "Atención"
  End If
  Exit Sub
errHandler:
  ManejaErrores
...
Private Sub CargarLista()
  ...
  List1.Clear
  Set Rs = cRsl.TraerRS("MarcaTraerTodos", , True)

  Do While Not Rs.EOF
     List1.AddItem Rs!Descripcion
     List1.ItemData(List1.NewIndex) = Rs!Marca
     Rs.MoveNext
  Loop
  Set cRsl = Nothing
  Exit Sub
...
Private Sub Grabar()
  ...
  If CmdBotones(2).Caption = "Grabar" Then
     cRse.Actualizar "MarcaModif", Rs1, Val(Label3.Caption)
  Else
     cRse.Actualizar "MarcaAgregar", Rs1
  End If
  Rs1.Close
  bMarca = True
  Set cRse = Nothing
