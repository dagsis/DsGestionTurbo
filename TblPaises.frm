VERSION 5.00
Begin VB.Form TblPaises 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Tablas de Paises"
   ClientHeight    =   3525
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6510
...
Private Sub LinkearTexto()
  Label3.Caption = Format(rs!Pais, "00")
...
Private Sub List1_Click()
 ...
 Set rs = cRsl.TraerRS("PaisTraerUno", sCod, True)
 LinkearTexto
 Set cRsl = Nothing
Exit Sub
errHandler:
...
Private Sub CargarLista()
  ...
  List1.Clear
  Set rs = cRsl.TraerRS("PaisTraerTodos", , True)

  Do While Not rs.EOF
     List1.AddItem rs!Descripcion
     List1.ItemData(List1.NewIndex) = rs!Pais
     rs.MoveNext
  Loop
  Set cRsl = Nothing
  Exit Sub
...
Private Sub Grabar()
  ...
  If CmdBotones(2).Caption = "Grabar" Then
     cRse.Actualizar "PaisModif", Rs1, Val(Label3.Caption)
  Else
     cRse.Actualizar "PaisAgregar", Rs1
  End If
  Rs1.Close
  Set cRse = Nothing
  bPais = True
